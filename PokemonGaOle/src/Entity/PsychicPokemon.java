...
public class PsychicPokemon extends Pokemon {
	public PsychicPokemon(String name,
		...
		super(name, healthPoints, PokemonTypes.Psychic, attack, defense, speed);
	}
	...
	public double getEffectiveness(PokemonTypes attackType, PokemonTypes defenderTypes) {
		...
		if (defenderTypes == PokemonTypes.Fighting || defenderTypes == PokemonTypes.Poison)
		{
			effectiveness *= 2;
		}
		...
		else if (defenderTypes == PokemonTypes.Steel || defenderTypes == PokemonTypes.Psychic)
		{
			effectiveness *= 0.5;
		}
		else 
